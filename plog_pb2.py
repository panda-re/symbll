...
_LLVMENTRY = _descriptor.Descriptor(
  name='LLVMEntry',
  full_name='panda.LLVMEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='panda.LLVMEntry.type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pc', full_name='panda.LLVMEntry.pc', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='address', full_name='panda.LLVMEntry.address', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='panda.LLVMEntry.value', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_bytes', full_name='panda.LLVMEntry.num_bytes', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tb_num', full_name='panda.LLVMEntry.tb_num', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='addr_type', full_name='panda.LLVMEntry.addr_type', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cpustate_offset', full_name='panda.LLVMEntry.cpustate_offset', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='condition', full_name='panda.LLVMEntry.condition', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='phi_index', full_name='panda.LLVMEntry.phi_index', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='flags', full_name='panda.LLVMEntry.flags', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vma_name', full_name='panda.LLVMEntry.vma_name', index=11,
...
_LOGENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='llvmEntry', full_name='panda.LogEntry.llvmEntry', index=21,
...
_LOGENTRY.fields_by_name['llvmEntry'].message_type = _LLVMENTRY
...
DESCRIPTOR.message_types_by_name['LLVMEntry'] = _LLVMENTRY
...
LLVMEntry = _reflection.GeneratedProtocolMessageType('LLVMEntry', (_message.Message,), dict(
  DESCRIPTOR = _LLVMENTRY,
  __module__ = 'plog_pb2'
  # @@protoc_insertion_point(class_scope:panda.LLVMEntry)
  ))
_sym_db.RegisterMessage(LLVMEntry)
