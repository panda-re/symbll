                ...
                if insn.called_function.name.startswith('helper_set_cp_reg_llvm'):
                    ...
                    if insn.called_function.name:
                        try:
                            ...
                            if insn.called_function not in list_defined_functions:
                                list_defined_functions.append(insn.called_function)
                        except:
                            if insn.called_function not in list_declared_functions:
                                list_declared_functions.append(insn.called_function)
                            plog.next()
                    else:
                        print (bb)
                        print (insn)
                        if insn.called_function not in list_functionpointer:
